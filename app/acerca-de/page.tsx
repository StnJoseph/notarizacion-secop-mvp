    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-gray-900 text-lg mb-2">¿Esto reemplaza SECOP II?</h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 text-lg mb-2">¿Es verificable públicamente?</h3>
            <p className="text-gray-700">
              Sí. Puedes validar cualquier transacción en Polygonscan sin necesidad de autenticación.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-gray-900 text-lg mb-2">¿Qué pasa con datos sensibles?</h3>
            <p className="text-gray-700">
